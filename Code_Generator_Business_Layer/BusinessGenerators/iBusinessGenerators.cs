...
{
    /// <summary>
    /// Defines the contract for business layer code generators to produce C# code components, including properties, constructors, and CRUD operations.
    /// </summary>
    internal interface iBusinessGenerators
    {
        ...
        /// </summary>
        /// <returns>A string containing the generated C# property declarations.</returns>
        string GenerateProperties();

        /// <summary>
        /// Generates the business logic method responsible for inserting a new record into the database.
        /// </summary>
        /// <returns>A string containing the C# code for the Create method.</returns>
        ...
        /// </summary>
        /// <returns>A string containing the C# code for the ReadAll method.</returns>
        ...
        /// </summary>
        /// <returns>A string containing the C# code for the public constructor.</returns>
        ...
        /// </summary>
        /// <returns>A string containing the C# code for the parameterized constructor.</returns>
        ...
        /// </summary>
        /// <returns>A string containing the C# code for the Save method.</returns>
        string GenerateSaveMethod();

        /// <summary>
        /// Generates the complete Business Layer class, assembling usings, namespace declarations, class definition, properties, and all methods.
        /// </summary>
        /// <returns>A string containing the entire generated C# class file content.</returns>
